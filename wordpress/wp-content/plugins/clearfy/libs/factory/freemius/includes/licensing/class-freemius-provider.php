...
namespace WBCR\Factory_Freemius_124\Premium;

use WBCR\Factory_Freemius_124\Entities\License;
use WBCR\Factory_Freemius_124\Entities\Plugin;
use WBCR\Factory_Freemius_124\Entities\Site;
use WBCR\Factory_Freemius_124\Entities\User;
use WBCR\Factory_437\Premium\Provider as License_Provider;
use Wbcr_Factory437_Plugin;
use WBCR\Factory_Freemius_124\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_124\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory437_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_124\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_124\Api
	 * @throws Exception
	 */
