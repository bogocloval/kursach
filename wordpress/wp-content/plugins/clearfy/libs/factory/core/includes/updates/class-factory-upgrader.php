...
class Upgrader {
	 ...
	 * [
	 *  'wordpress' => 'WBCR\Factory_Freemius_124\Updates\Freemius_Repository',
	 *  'freemius' => '\WBCR\Factory_437\Updates\Wordpress_Repository'
	 * ]
	 */
	...
	public function __construct( Wbcr_Factory437_Plugin $plugin ) {
		...
		self::$repositories['wordpress'] = '\WBCR\Factory_437\Updates\Wordpress_Repository';
	...
	protected function get_repository( $repository_name ) {
		...
		if ( isset( self::$repositories[ $repository_name ] ) && class_exists( self::$repositories[ $repository_name ] ) ) {
			if ( self::$repositories[ $repository_name ] instanceof Repository ) {
				throw new Exception( "Repository {$repository_name} must extend the class WBCR\Factory_437\Updates\Repository interface!" );
			}
