...
namespace WBCR\Factory_437\Components;
...
class Install_Button {
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory437_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WbcrFactoryClearfy228_Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_437'),
			'install' => __('Install', 'wbcr_factory_437'),
			'deactivate' => __('Deactivate', 'wbcr_factory_437'),
			'delete' => __('Delete', 'wbcr_factory_437'),
			'loading' => __('Please wait...', 'wbcr_factory_437'),
			'preparation' => __('Preparation...', 'wbcr_factory_437'),
			'read' => __('Read more', 'wbcr_factory_437')
		];
	}
