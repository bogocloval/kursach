<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages436::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages436::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages436') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages436 {

			/**
			 * @var Wbcr_FactoryPages436_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory437_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_436_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory437_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_436_get_page_id($plugin, $page_id)
		{
