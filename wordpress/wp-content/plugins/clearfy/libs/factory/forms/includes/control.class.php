<?php
	...
	if( !class_exists('Wbcr_FactoryForms434_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms434_Control extends Wbcr_FactoryForms434_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms434_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms434_ValueProvider $provider
			 * @return void
			 */
