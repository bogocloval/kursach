<?php
	...
	if( !class_exists('Wbcr_FactoryForms434_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms434_Bootstrap3FormLayout extends Wbcr_FactoryForms434_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms434_Control $control
			 */
