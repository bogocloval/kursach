<?php
	...
	if( !class_exists('Wbcr_FactoryForms434_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms434_TabHolder extends Wbcr_FactoryForms434_Holder {
			 ...
			 * @param FactoryForms434_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms434_HtmlAttributeBuilder();
