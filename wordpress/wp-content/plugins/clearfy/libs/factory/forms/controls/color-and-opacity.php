<?php
	...
	if( !class_exists('Wbcr_FactoryForms434_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms434_ColorAndOpacityControl extends Wbcr_FactoryForms434_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms434_IntegerControl($options['opacity'], $form, $provider);
