<?php
	 ...
	 *  // see FactoryForms434_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms434_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms434_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms434_DropdownAndColorsControl extends Wbcr_FactoryForms434_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms434_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms434_RadioColorsControl($options['colors'], $form, $provider);
