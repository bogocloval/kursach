...
if ( ! function_exists( 'icycp_agencyup_top_contact' ) ) :
	...
	$contact_one_icon = get_theme_mod('contact_one_icon','fa fa-map-marker');
	$contact_one_title = get_theme_mod('contact_one_title','Head Office');
	$contact_one_description = get_theme_mod('service_one_icon','4578 Marmora Road, Glasgow');

	$contact_two_icon = get_theme_mod('contact_two_icon','fa fa-phone');
	...
	$contact_three_icon = get_theme_mod('contact_three_icon','fa fa-envelope-open');
		...
		<?php } ?>
			<div class="row">
			  <div class="col-sm-4 col-md-4 swing animated service-one">
			  	<div class="bs-sevice two text-center shd" style="background-image: url('<?php echo ICYCP_PLUGIN_URL ?>inc/agencyup/images/service/service1.jpg');">
              ...
              <div class="col-sm-4 col-md-4 swing animated service-one">
			  	<div class="bs-sevice two text-center shd" style="background-image: url('<?php echo ICYCP_PLUGIN_URL ?>inc/agencyup/images/service/service2.jpg');">
                 <div class="bs-sevice-inner">
                    ...
                    <?php 
					$ser_two_btn_link = get_theme_mod('ser_one_btn_link','#');
					$ser_two_btn_text = get_theme_mod('ser_one_btn_text',__('Read More','#'));
					$ser_two_btn_tab = get_theme_mod('ser_one_btn_tab',false);
					if($ser_two_btn_text !='')
					{ ?>
              ...
              <div class="col-sm-4 col-md-4 swing animated service-one">
			  	<div class="bs-sevice two text-center shd" style="background-image: url('<?php echo ICYCP_PLUGIN_URL ?>inc/agencyup/images/service/service3.jpg');">
                 <div class="bs-sevice-inner">
        ...
        <div class="col text-center">
          <div class="bs-heading">
			...
			<?php $news_section_title = get_theme_mod('news_section_title',__('Latest News','consultup'));?>
              <h2 class="bs-title"><?php echo esc_html($news_section_title);?></h2>
